            ...
            <ModalDescription>
              ...
              <article>
                <section>
                  ...
                  <ol>
                    <li>
                      Try to click outside of the modal, it shouldn't allow one
                      to do so.
                    </li>
                    <li>It should also disable the scroll outside.</li>
                    <li>
                      Try to press the tab keys and navigate, it should only
                      focus on elements that are inside of this modal.
                    </li>
                    <li>
                    ...
                    <li>
                      Try to open this modal when a screen reader is on. It
                      should read out "Hello world!" and "This is an example of
                      a regular modal" bit... above as that is the title and
                      description of the modal respectively and focus on the
                      "jay@shahjay.io" email link when the modal opens
                      initially. If you're on MacOS, you can use{' '}
                      <code>CMD + F5</code> to toggle screen reader.
                    </li>
                  </ol>
                  <aside>
                    <small>
